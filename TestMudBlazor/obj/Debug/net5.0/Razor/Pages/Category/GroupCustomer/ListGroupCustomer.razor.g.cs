#pragma checksum "C:\Project\FontEnd\Blazor\MudblazorTest\TestMudBlazor\Pages\Category\GroupCustomer\ListGroupCustomer.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e83b9d748840b28af1bcdc3a526cb2642dfecc70"
// <auto-generated/>
...
{
        new EarningReport { ma = "NKH01", name = "a", action = true , avorite = true, order = "10" },
        new EarningReport { ma = "NKH02", name =  "b" ,  action = false, avorite = true, order = "35"},
        new EarningReport { ma = "NKH03", name = "c",  action = true, avorite = false, order = "27" },
        };
